...
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file /kaggle/working/aip/source/res/src/config/config_fsdp_t5.yaml /kaggle/working/aip/source/res/src/train.py        \
        --module 'res' \
